...
<html lang="es" class="clear-section">
  ...
  <body>
    <div id="app" class="clear-section">
      ...
      <div class="float-left secondary-header head head_derechoautor">
      ...
      >
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-12 float-left eje-box-outer grid" onclick="location.href='derecho_autor_registrar.php';">
