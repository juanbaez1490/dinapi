...
<html lang="es" class="clear-section">
  ...
  <body>
    <div id="app" class="clear-section">
      ...
      <div class="float-left secondary-header head head_patentes">
      ...
      >
        ...
        <div class="row">
          <div class="col-md-3 col-12 float-left eje-box-outer grid" onclick="location.href='https://servicios.dinapi.gov.py/';">
            <figure class="eje-box-inner effect-apollo" id="boxsup-2">
              <div class="icono-eje">
                ...
                <div class="texto-eje h2">Buscador de Patentes</div>
              </div>
              <figcaption>
                <p>
          ...
          <div class="col-md-3 col-12 float-left eje-box-outer grid" onclick="location.href='patentes_aprender.php';">
            <figure class="eje-box-inner effect-apollo" id="boxsup-3">
              ...
              <figcaption>
                <p>Aquí encontrará toda la información para conocer sobre esta área</p>
                <a href="#">Vea más</a>
              </figcaption>
            </figure>
          </div>

          <div class="col-md-3 col-12 float-left eje-box-outer grid" onclick="location.href='patentes_registrar.php';">
            <figure class="eje-box-inner effect-apollo" id="boxsup-1">
              ...
              <figcaption>
                <p>
                  Aquí encontrará toda la información sobre lo que se requiere para registrar una patente
                </p>
                <a href="#">Vea más</a>
              </figcaption>
            </figure>
