...
<html lang="es" class="clear-section">
  ...
  <body>
    <div id="app" class="clear-section">
      ...
      <div class="float-left secondary-header head head_igydo">
      ...
      >
        ...
        <div class="row">
          <div class="col-md-3 col-12 float-left eje-box-outer grid">
            <figure class="eje-box-inner effect-apollo" id="boxsup-2">
              <div class="icono-eje">
                ...
                <div class="texto-eje h2">Buscador</div>
              </div>
              <figcaption>
                <p>
          ...
          <div class="col-md-3 col-12 float-left eje-box-outer grid" onclick="location.href='igydo_aprender.php';">
          ...
          <div class="col-md-3 col-12 float-left eje-box-outer grid" onclick="location.href='igydo_registrar.php';">
