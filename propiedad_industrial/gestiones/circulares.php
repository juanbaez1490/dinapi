    ...
    <div id="app" class="clear-section">
      ...
      >
        ...
        <div class="col-md-12 bread">
          <div><a href="<?php echo $URL_Base; ?>index.php">Inicio</a> / <a href="index.php">Gestiones Administrativas</a> / CIRCULARES Y DECISIONES ADMINISTRATIVAS DE LA DIRECCIÓN GENERAL DE PROPIEDAD INDUSTRIAL </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-8 mt-5 information-texto">
            ...
            <h2 class="inicial">
              CIRCULARES Y DECISIONES ADMINISTRATIVAS DE LA DIRECCIÓN GENERAL DE PROPIEDAD INDUSTRIAL 
            </h2>
          

            <button type="button" class="btn btn-info" onclick=" window.open('https://www.dinapi.gov.py/application/files/5515/6208/0243/Circular_03_2019.pdf','_blank')">
              Circular N° 03/2019
            </button>
            <br><br>
