...
if (!empty($_POST)){
    if(!empty($_POST['codigo'])){ //para hacer update de noticia
        ...
        $sql = "UPDATE noticia set titulo='$titulo', categoria=$idCategoria, destacado='$destacado', cuerpo='$cuerpo' WHERE codigo = $codigo";
...
//Parametros Recibidos
    ...
    $mysqli->real_query("SELECT codigo, titulo, cuerpo, categoria, destacado FROM noticia WHERE codigo = ".$codigo);
...
<div class="col-md-12 cuerpoNoticias">
    ...
    <form action="" method="post">
        ...
        <div class="col-md-12 titulo-adm">
            <center><h2>Modificar Noticia</h2> <?php echo $categoria." categoria"?></center>
        </div>
        <div class="col-md-6">
                    ...
                    <div class="form-group">
                            ...
                            <?php
                                ...
                                $mysqli->real_query("SELECT * FROM categoria_noticia WHERE id = ".$categoria);
                                $resultado = $mysqli->use_result();
                                while ($fila = $resultado->fetch_assoc()) {
                                    $descripcion = $fila['descripcion'];
                                    $idCategoria = $fila['id'];
                            ?>
                                        <option VALUE="<?php echo $idCategoria; ?>" selected="">
                            ...
                            <?php
                                ...
                                while ($fila = $resultado->fetch_assoc()) {
                                    ...
                                    if($padre == 0){
                            ?>
                                        <option style="font-weight:bold;" VALUE="<?php echo $idCategoria; ?>">
                                            <?php echo $descripcion; ?> 
                                        </option>  
                            <?php
                                    } else {
                    ...
                    <div class="checkbox">
                        <label>
                            <?php
                                ...
                                {
                            ?>
                                    <input name="destacado" type="checkbox" checked /> Destacado?  
                            <?php
                                } elseif ($destacado == "of") {
                            ?>
        ...
        <div class="editor col-md-6">
              ...
              <textarea id="editor1" name="cuerpo" placeholder="Ingrese aqui el cuerpo de la noticia..." rows="10">
                <?php echo $cuerpo ?>
              </textarea>
        </div>
