...
*/
            ...
            VALUES ('".$codigo."', '".$titulo."', '".$stringAMostrar."', '".$categoria."', '".$destacado."', '".$fechaHora."')";
...
<?php
    ...
    $mysqli->real_query("SELECT n.id, n.codigo, n.titulo, c.descripcion FROM noticia n INNER JOIN categoria_noticia c ON c.id = n.categoria ORDER BY n.codigo DESC LIMIT 100");
    $resultado = $mysqli->use_result();
    $cont = 0;
    while ($fila = $resultado->fetch_assoc()) {
        $id = $fila['id'];
