...
*/
            ...
            $sql = "INSERT INTO album (codigo, titulo, descripcion, categoria, fecha)
            VALUES ('".$codigo."', '".$titulo."', '".$data."', '".$categoria."', '".$fechaHora."')";
    ...
    $mysqli->real_query("SELECT codigo, titulo FROM album ORDER BY codigo DESC LIMIT 1");
    $resultado = $mysqli->use_result();
    ...
    <form action="album_editor.php" method="post">
        ...
        ?>
                        <div class="alert alert-success col-md-12" role="alert">
                          ...
                          ¡Excelente! El &Aacute;lbum se cre&oacute; con &eacute;xito.
                        </div>
        <?php
                    }else {
        ?>
                        <div class="alert alert-danger col-md-12" role="alert">
                          ...
                          <span class="sr-only">Error:</span>
                          Ocurri&oacute; un Error al intentar guardar el &Aacute;lbum.
                        </div>
        <?php
                    }
                }
        ...
        ?>
                        <div class="alert alert-success col-md-12" role="alert">
                          <span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
                          <span class="sr-only">Error:</span>
                          ¡Excelente! El &Aacute;lbum se ELIMIN&Oacute; con &eacute;xito.
                        </div>
        <?php
                    }else {
        ?>
                        <div class="alert alert-danger col-md-12" role="alert">
                          <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                          <span class="sr-only">Error:</span>
                          Ocurri&oacute; un Error al intentar eliminar el &Aacute;lbum.
                        </div>
        <?php
                    }
                }
        ...
        <div class="col-md-12 titulo-adm">
            <center><h2>&Aacute;lbum Nuevo</h2></center>
        </div>
        <div class="col-md-6">
                    ...
                    <div class="form-group">
                            ...
                            <?php
                                ...
                                $mysqli->real_query("SELECT * FROM categoria_album ORDER BY codigo ASC");
                                $resultado = $mysqli->use_result();
                                while ($fila = $resultado->fetch_assoc()) {
                                    $id = $fila['codigo'];
        ...
        <div class="editor col-md-6">
              ...
              <textarea id="editor1" name="editor" placeholder="Ingrese aqui la nota del &aacute;lbum..." rows="10"></textarea>
        </div>
        ...
        <div class="col-md-12 contenido-centrado">
                    <input type="submit" class="btn btn-primary col-offset-6" value="Cargar &Aacute;lbum"/>
        </div>
...
<div class="col-md-12 titulo-adm tabla-lista-noticias tabla-lista-noticias">
    <center><h2>Lista &Aacute;lbumes</h2></center>
</div>
<div class="col-md-12 cuerpoNoticias">
        <div class="col-md-12">
...
<?php
    ...
    $mysqli->real_query("SELECT a.codigo, a.codigo, a.titulo, a.categoria FROM album a INNER JOIN categoria_album c ON c.codigo = a.categoria ORDER BY a.codigo DESC LIMIT 100");
    $resultado = $mysqli->use_result();
    $cont = 0;
    while ($fila = $resultado->fetch_assoc()) {
        $codigo = $fila['codigo'];
                    ...
                    <td>
                        ...
                        <div style="float:left; margin-left: 5px;">
                            <form action="imagen_editor.php" method="post">
                                <input type="hidden" name="codigoAlbum" value="<?php echo $codigo; ?>"/>
                                <input type="submit" class="btn col-offset-6" value="Insertar Fotos"/>
                            </form>
                        </div>
                    </td>
                </tr>
